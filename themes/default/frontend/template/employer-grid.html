      ...
      <div class="navbar-collapse collapse justify-content-start">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <ul class="dropdown-menu">
              <li class="active"><a class="dropdown-item" href="employer-grid.html">Employer Grid</a></li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="row mb-4">
          <div class="col-12">
            <h6 class="mb-0">Showing 1-10 of <span class="text-primary">28 Employer</span></h6>
          </div>
        </div>
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Fast Systems Consultants</a></h5>
                  </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Pendragon Green Ltd</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Wight Sound Hearing LLC</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Tan Electrics Ltd</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Northwood (Torbay) Ltd</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">NameThe Raj Douth</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">NameThe Bridalworks</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Carphone Warehouse</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
            ...
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  ...
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
                      <li><i class="fas fa-filter pe-1"></i>Education</li>
              ...
              <div class="employers-list-position">
                <a class="btn btn-sm btn-dark" href="#">45 Open position</a>
              </div>
            </div>
          </div>
          <div class="col-md-6 mb-4">
            <div class="employers-grid text-center">
              ...
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
                    <h5 class="mb-0"><a href="employer-detail.html">Wollens Building Supplies</a></h5>
                  </div>
                  <div class="employers-list-option">
                    <ul class="list-unstyled">
                      <li><i class="fas fa-filter pe-1"></i>Energy</li>
              ...
              <div class="employers-list-position">
                <a class="btn btn-sm btn-dark" href="#">50 Open position</a>
              </div>
            </div>
          </div>
        </div>
