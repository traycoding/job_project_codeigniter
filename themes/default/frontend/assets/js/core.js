...
$('body').on('click','td ul li #view',function() {alert("jflsdfjslkdjf");})
function cssStyle() {
...
function img_slide_shows(x) {
    var image_link = x == null || x == '' ? 'no_image.png' : x;
    return (
        '<div class="text-center"><a href="' +
        site.url +
        '/themes/default/frontend/assets/img/slide/' +
        image_link +
        '" data-toggle="lightbox"><img src="' +
        site.url +
        '/themes/default/frontend/assets/img/slide/' +
...
function property_img(x){
     var image_link = x == null || x == '' ? 'no_image.png' : x;
    return (
        '<div class="text-center"><a href="' +
        site.url +
        'themes/default/frontend/assets/img/properties/' +
        image_link +
        '" data-toggle="lightbox"><img src="' +
        site.url +
        'themes/default/frontend/assets/img/properties/thumbs/' +
        image_link +
        '" alt="" style="width:30px; height:30px;" /></a></div>'
    );
}
function blog_img(x){
    ...
    return (
        '<div class="text-center"><a href="' +
        site.url +
        'themes/default/frontend/assets/img/blog/thumbs/'+
        image_link +
        '" data-toggle="lightbox"><img src="' +
        site.url +
        'themes/default/frontend/assets/img/blog/thumbs/' +
...
function category_img(x){
     var image_link = x == null || x == '' ? 'no_image.png' : x;
    return (
        '<div class="text-center"><a href="' +
        site.url +
        'themes/default/frontend/assets/img/category/'+
        image_link +
        '" data-toggle="lightbox"><img src="' +
        site.url +
        'themes/default/frontend/assets/img/category/' +
...
function products_img(x){
     var image_link = x == null || x == '' ? 'no_image.png' : x;
    return (
        '<div class="text-center"><a href="' +
        site.url +
        'themes/default/frontend/assets/img/products/'+
        image_link +
        '" data-toggle="lightbox"><img src="' +
        site.url +
        'themes/default/frontend/assets/img/products/' +
...
function  slide_shows_status(x)
{
     return x == 1
        ? 
              '<div class="text-center"> <span class="label label-success text-center" style="font-size:11px;" >' +
              'Active' +
              '</span></div>'
        : '<div class="text-center"><span class="label label-danger text-center" style="font-size:11px;"><i class="fa fa-times"></i> ' +
              ' Inactive '+
              '</span></div>';
}
...
{
      if(x==1){
         return  '<div class="text-center"> <span class="label label-success text-center" style="font-size:11px;" >' +
              'Time' +
              '</span></div>';
      }else if(x==2){
        return  '<div class="text-center"> <span class="label label-warning text-center" style="font-size:11px;" >' +
              'Day' +
              '</span></div>';
      }else if(x==3){
         return  '<div class="text-center"> <span class="label label-info text-center" style="font-size:11px;" >' +
              'Month' +
              '</span></div>';
      }      
}
function news_status(x)
{
    if(x==1){
        return '<div class="text-center"> <span class="label label-success text-center" style="font-size:11px;" ><i class="fa fa-check"></i>' +
              'active' +
              '</span></div>';
    }
    else{
        return '<div class="text-center"> <span class="label label-danger text-center" style="font-size:11px;" ><i class="fa fa-times"></i>' +
              'inactive' +
              '</span></div>';
    }
}
...
$(document).ready(function () {
    $('#view-customer').click(function (e) {
        ...
        $('#view-agency').click(function (e) {
        e.preventDefault();
        if ($('input[name="agency"]').val()) {
            $('#myModal').modal({ remote: site.base_url + 'agencys/view/' + $('input[name=agency]').val() });
            $('#myModal').modal('show');
        }
        return false;
    });
...
// heng
    $('body').on('click', '.agency_details_link td:not(:first-child, :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'agencys/view/' + $(this).parent('.agency_details_link').attr('id'),
        });
        $('#myModal').modal('show');
    });
    ...
    $('body').on('click', 'td ul li #view', function () {
        $('#myModal').modal({
    ...
    $('body').on('click', '.property_link td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'property/modal_view/' + $(this).parent('.property_link').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });
    $('body').on('click', '.property_link2 td:first-child, .property_link2 td:nth-child(2)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'property/modal_view/' + $(this).closest('tr').attr('id'),
        });
        $('#myModal').modal('show');
    });
     $('body').on('click', '.news_link td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'news/modal_view/' + $(this).parent('.news_link').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });
    // tray
     $('body').on('click', '.link_blogs td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'blogs/modal_view/' + $(this).parent('.link_blogs').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });
     $('body').on('click', '.link_category td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'category/modal_view/' + $(this).parent('.link_category').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });

      $('body').on('click', '.products_link td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'company_products/modal_view/' + $(this).parent('.products_link').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });
       $('body').on('click', '.category_link td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'category/modal_view/' + $(this).parent('.category_link').attr('id'),
        });
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'products/view/' + $(this).parent('.product_link').attr('id');
    });
      
    $('body').on('click', '.news_link2 td:first-child, .news_link2 td:nth-child(2)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'news/modal_view/' + $(this).closest('tr').attr('id'),
        });
        $('#myModal').modal('show');
    });
...
// heng
   $('body').on('click', '.agency_link td:not(:first-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'agencys/edit/' + $(this).parent('.agency_link').attr('id'),
        });
        $('#myModal').modal('show');
    });
