<!--=================================
Banner -->
<section class="banner bg-holder bg-overlay-black-30 text-white" style="background-image: url(<?= $frontend_assets; ?>images/bg/banner-01.jpg);">
  <div class="container">
    <div class="row">
          ...
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row mt-3">
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/10.svg" alt="">
                  </div>
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/09.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class=" job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/06.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/17.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/18.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/19.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
          ...
          <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="row mt-4">
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/11.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/12.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class=" job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/13.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/14.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/15.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/16.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
          ...
          <div class="tab-pane fade show" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <div class="row mt-4">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/20.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/01.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/02.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
      ...
      <div class="col-lg-7 mb-4 mb-lg-0">
        ...
        <div class="candidate-list">
          <div class="candidate-list-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/avatar/04.jpg" alt="" >
          </div>
        ...
        <div class="candidate-list">
          <div class="candidate-list-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/avatar/01.jpg" alt="" >
          </div>
          <div class="candidate-list-details">
            <div class="candidate-list-info">
              <div class="candidate-list-title">
        ...
        <div class="candidate-list">
          <div class="candidate-list-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/avatar/05.jpg" alt="" >
          </div>
          <div class="candidate-list-details">
            <div class="candidate-list-info">
              <div class="candidate-list-title">
      ...
      <div class="col-lg-4">
        ...
        <div class="owl-carousel owl-nav-bottom-center" data-nav-arrow="false" data-nav-dots="true" data-items="1" data-md-items="1" data-sm-items="2" data-xs-items="1" data-xx-items="1" data-space="15" data-autoheight="true">
          ...
          <div class="item">
            <div class="employers-grid">
              <div class="employers-list-logo">
                <img class="img-fluid" src="<?= $frontend_assets; ?>images/svg/08.svg" alt="">
              </div>
              <div class="employers-list-details">
                <div class="employers-list-info">
                  <div class="employers-list-title">
...
<section class="space-pb">
  <div class="container">
    ...
    <div class="row bg-holder-pattern mt-3 mt-md-4 me-md-0 ms-md-0" style="background-image: url('<?= $frontend_assets; ?>images/step/pattern-01.png');">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-md-5 mb-lg-0 pe-lg-5">
        <div class="row">
          <div class="col-sm-7">
            <img class="img-fluid w-100" src="<?= $frontend_assets; ?>images/about/01.png" alt="">
          </div>
          <div class="col-sm-5 mt-sm-5 mt-4">
            <img class="img-fluid mb-sm-2 w-100" src="<?= $frontend_assets; ?>images/about/02.png" alt="">
            <div class=" mt-3">
              <a class="popup-icon popup-youtube bg-holder bg-overlay-black-80" href="https://www.youtube.com/watch?v=LgvseYYhqU0">
                <i class="flaticon-play-button"></i>
                <img class="img-fluid w-100" src="<?= $frontend_assets; ?>images/about/03.png" alt="">
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="owl-carousel owl-nav-top-center" data-nav-arrow="true"  data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="0">
          <div class="item">
            <div class="testimonial-item text-center">
              <div class="avatar">
                <img class="img-fluid rounded-circle" src="<?= $frontend_assets; ?>images/avatar/04.jpg" alt="">
              </div>
          ...
          <div class="item">
            <div class="testimonial-item text-center">
              <div class="avatar">
                <img class="img-fluid rounded-circle" src="<?= $frontend_assets; ?>images/avatar/02.jpg" alt="">
              </div>
              <div class="testimonial-content">
        ...
        <div class="bg-light px-lg-5">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 mt-4 mt-md-5 text-center">
              <img class="img-fluid" src="<?= $frontend_assets; ?>images/mobile-app.png" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-4 mb-md-0 mb-4">
        <div class="blog-post justify-content-center text-center">
          <div class="blog-post-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/blog/03.jpg" alt="">
          </div>
      ...
      <div class="col-md-4 mb-md-0 mb-4">
        <div class="blog-post text-center">
          <div class="blog-post-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/blog/04.jpg" alt="">
          </div>
          <div class="blog-post-content">
            <div class="blog-post-details pb-0">
              <div class="blog-post-time">
      ...
      <div class="col-md-4">
        <div class="blog-post text-center">
          <div class="blog-post-image">
            <img class="img-fluid" src="<?= $frontend_assets; ?>images/blog/05.jpg" alt="">
          </div>
          <div class="blog-post-content">
            <div class="blog-post-details pb-0">
              <div class="blog-post-time">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 mb-4 mb-sm-5 mb-lg-0">
        <div class="d-sm-flex">
          <div class="align-self-center footer-top-logo"><img class="img-fluid" src="<?= $frontend_assets; ?>images/logo-dark.svg" alt=""></div>
          <div class="ps-sm-3 ms-sm-3 mt-3 mt-sm-0 border-sm-start">Create a free account to find thousands of Jobs, Employment & Career Opportunities around you!</div>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="row">
