                  ...
                  <div class="col-lg-9">
                    ...
                    <div class="job-filter mb-4 d-sm-flex align-items-center">
                      ...
                      <div class="job-shortby ms-sm-auto d-flex align-items-center">
                        ...
                        <div class="filter-btn ms-sm-3 ms-auto"> <a class="btn btn-outline-primary" href="#"><i class="fa fa-filter"></i>Show Filter </a> </div>
                      </div>
                    </div>
                    <div class="row">
                      <?php
                                ...
                                <div class="job-list-details">
                                  <div class="job-list-info">
                                    <div class="job-list-title">
                                      <h5 class="mb-0"><a href="job-detail.html"><?= $job->name ?></a></h5>
                                    </div>
