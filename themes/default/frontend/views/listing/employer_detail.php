            ...
            <div class="employers-list-info">
              ...
              <div class="employers-list-option">
                <ul class="list-unstyled">
                  <li><i class="fas fa-map-marker-alt pe-1"></i>214 West Arnold St.New York</li>
                  <li><i class="fa fa-phone fa-flip-horizontal ps-1"></i>(123) 345-6789</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="d-flex">
                ...
                <div class="feature-info-content ps-3">
                  ...
                  <span class="mb-0 fw-bold d-block text-dark">164</span>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="d-flex">
                ...
                <div class="feature-info-content ps-3">
                  ...
                  <span class="mb-0 fw-bold d-block text-dark">United States</span>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="d-flex">
                ...
                <div class="feature-info-content ps-3">
                  ...
                  <span class="mb-0 fw-bold d-block text-dark">Arts, Design, Media</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 mb-sm-0 mb-4">
              <div class="d-flex">
                ...
                <div class="feature-info-content ps-3">
                  ...
                  <span class="mb-0 fw-bold d-block text-dark">15</span>
                </div>
              </div>
            </div>
            ...
            <div class="similar-jobs-item widget-box">
                ...
                <div class="job-list-details">
                  <div class="job-list-info">
                    <div class="job-list-title">
                      <h6><a href="job-detail.html">Designer Required</a></h6>
                    </div>
              ...
              <div class="job-list">
                ...
                <div class="job-list-details">
                  <div class="job-list-info">
                    <div class="job-list-title">
                      <h6><a href="job-detail.html">Post Room Operative</a></h6>
                    </div>
                    <div class="job-list-option">
                      <ul class="list-unstyled">
                        <li>
              ...
              <div class="job-list">
                ...
                <div class="job-list-details">
                  <div class="job-list-info">
                    <div class="job-list-title">
                      <h6><a href="job-detail.html">Stockroom Assistant</a></h6>
                    </div>
                    <div class="job-list-option">
                      <ul class="list-unstyled">
                        <li>
              ...
              <div class="job-list">
                ...
                <div class="job-list-details mb-0">
                  <div class="job-list-info">
                    <div class="job-list-title">
                      <h6><a href="job-detail.html">Research Administrator</a></h6>
                    </div>
                    <div class="job-list-option">
                      <ul class="list-unstyled">
                        <li>
