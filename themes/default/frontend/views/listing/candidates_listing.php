  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="row mb-4">
          <div class="col-12">
            <h6 class="mb-0">Showing <?= $num."-".$total ?> of <span class="text-primary"><?= $counts ?> Candidates</span></h6>
          </div>
        </div>
              ...
              <div class="candidate-list-details">
                <div class="candidate-list-info">
                  <div class="candidate-list-title">
                    <h5 class="mb-0"><a href="#"><?= $candidate->last_name."  ".$candidate->first_name ?></a></h5>
                  </div>
