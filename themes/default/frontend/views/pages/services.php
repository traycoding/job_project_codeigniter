  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="row">
          <div class="col-sm-6">
            <ul class="ps-3 mb-0 list-style-2">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="feature-info feature-info-border text-center">
          ...
          <div class="feature-info-content">
            ...
            <p class="mb-0">So, how can we stay on course with all the distractions in our lives? Willpower is a good start, but it’s very difficult to stay on track.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="feature-info feature-info-border text-center">
          ...
          <div class="feature-info-content">
            ...
            <p class="mb-0">The price is something not necessarily defined as financial. It could be time, effort, sacrifice, money or perhaps, something else.</p>
          </div>
        </div>
      </div>
