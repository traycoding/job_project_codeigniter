...
class MY_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->data['assets']     = base_url() . 'themes/default/frontend/assets/';
        $this->data['frontend_assets']     = base_url() . 'themes/default/frontend/assets/';
    ...
    public function page_construct_frontend($page, $data = [], $meta = [])
    {
        ...
        $meta['employer']        = $this->session->userdata('employers');
        $meta['candidate']       = $this->session->userdata('candidates');
        $meta['id']              = $this->session->userdata('id');           
        $this->load->view($this->theme_frontend . 'header', $meta);
        $this->load->view($this->theme_frontend . $page, $data);
        $this->load->view($this->theme_frontend . 'footer');
    }
}
